...
import Background from './assets/thumbnail_BG.png'
import Hajje from './assets/thumbnail_Hajje.png'
...
function App() {
  ...
  return (
    ...
    >
      ...
      >
        <div id="container" style={{ flexBasis: '50%', marginTop: '20px' }}>
          <Minter
            amount={amount}
            setAmount={setAmount}
            connected={connected}
        ...
        <div
          id="hajje"
          style={{ flexBasis: '50%', alignSelf: 'flex-end', display: 'flex' }}
        >
          <img
            style={{
              objectFit: 'contain',
